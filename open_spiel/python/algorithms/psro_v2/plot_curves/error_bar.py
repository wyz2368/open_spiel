...
regret_mean = genfromtxt('./regularization_data/regret_fixed_RD_iter_mean.csv', delimiter=',')
regret_std = genfromtxt('./regularization_data/regret_fixed_RD_iter_std.csv', delimiter=',')

X = np.arange(1, 151)

plt.plot(X, regret_mean, color="C1", label='Regret of profiles within the empirical game')
