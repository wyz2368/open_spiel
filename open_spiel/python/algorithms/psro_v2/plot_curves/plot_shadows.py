...
Mike_fic_mean = genfromtxt('./data/2Nash_merged_csv/dqn_crd_035_randstart_Deepmind_mean.csv', delimiter=',')
Mike_fic_std = genfromtxt('./data/2Nash_merged_csv/dqn_crd_035_randstart_Deepmind_std.csv', delimiter=',')

dqn_do_mean = genfromtxt('./data/2Nash_merged_csv/dqn_DO_mean.csv', delimiter=',')[:100]
dqn_do_std = genfromtxt('./data/2Nash_merged_csv/dqn_DO_std.csv', delimiter=',')[:100]

Mike_prd_mean = genfromtxt('./data/2Nash_merged_csv/dqn_crd_035_randstart_Mike_mean.csv', delimiter=',')
Mike_prd_std = genfromtxt('./data/2Nash_merged_csv/dqn_crd_035_randstart_Mike_std.csv', delimiter=',')
...
plt.plot(X, Mike_fic_mean, color="C2", label='RD-based')
plt.fill_between(X, Mike_fic_mean+Mike_fic_std, Mike_fic_mean-Mike_fic_std, alpha=0.1, color="C2")

plt.plot(X, Mike_prd_mean, color="C0", label='NE-based')
