...
Mike_fic_mean = genfromtxt('./data/2Nash_merged_csv/dqn_prd_new_0gamma_deepmind_mean.csv', delimiter=',')
Mike_fic_std = genfromtxt('./data/2Nash_merged_csv/dqn_prd_new_0gamma_deepmind_std.csv', delimiter=',')
...
Mike_prd_std = genfromtxt('./data/2Nash_merged_csv/dqn_prd_new_deepmind_std.csv', delimiter=',')
...
plt.plot(X, Mike_fic_mean, color="C2", label='PRD0')
