...
from open_spiel.python.algorithms.IDO_psro import psro_v2
from open_spiel.python.algorithms.IDO_psro import rl_oracle
...
def gpsro_looper(env, oracle, agents, writer, quiesce=False, checkpoint_dir=None, seed=None):
  ...
  for gpsro_iteration in range(1,FLAGS.gpsro_iterations+1):
    ...
    if gpsro_iteration % 2 == 0:
        writer.add_scalar('exp', exploitabilities, gpsro_iteration//2)
    if FLAGS.verbose:
